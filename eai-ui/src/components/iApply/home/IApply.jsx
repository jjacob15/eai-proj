            ...
            <div className="card">
              <div className="card-block">
                <ul className="feed-blog">
                  <li className="active-feed">
                    <div className="feed-user-img">
                      <img alt="Test to Know" src={img} className="img-radius" />
                    </div>
                    <h6 className="m-b-0">Test to Know</h6>
                    <p className="text-muted m-b-15 m-t-5 small">
                      Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    </p>
                    <div className="row">
                  ...
                  <li className="active-feed">
                    <div className="feed-user-img">
                      <img alt="New Product Launch" src={img} className="img-radius" />
                    </div>
                    <h6 className="m-b-0">New Product Launch</h6>
                    <p className="text-muted m-b-15 m-t-5 small">
                      Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    </p>
                    <div className="row">
