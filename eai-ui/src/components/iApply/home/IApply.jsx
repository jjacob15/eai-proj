            ...
            <div className="card-block">
              <ul className="feed-blog">
                <li className="active-feed">
                  ...
                  <p className="text-muted m-b-15 m-t-5 small">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                  <div className="row">  
                    <div className="col-auto"><i className="fa fa-sign-in text-c-blue d-block f-20"></i></div>
                    <div className="col-auto"><i className="fa fa-info-circle text-c-green d-block f-20"></i></div>
                    <div className="col-auto"><i className="fa fa-upload text-c-yellow d-block f-20"></i></div>
                  </div>
                </li>
                <li className="active-feed">
                  <div className="feed-user-img">
